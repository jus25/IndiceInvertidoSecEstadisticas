...
public class Statistics {
    ...
    public void setProcessingFiles(int processingFiles) {
        ProcessingFiles = processingFiles;
    }

    public void incProcessingFiles() {
        ProcessingFiles++;
    }

    public void addProcessingFiles(int processingFiles) {
        ProcessingFiles += processingFiles;
    }

    public void decProcessingFiles() {
        ProcessingFiles--;
    }
    ...
    public void addProcessedFiles(int processedFiles) {
        ProcessedFiles += processedFiles;
    }
    ...
    public void incProcessedLines() {
        ProcessedLines++;
    }

    public void addProcessedLines(long processedLines) {
        ProcessedLines += processedLines;
    }
    ...
    public void setProcessedWords(long processedWords) {
        ProcessedWords = processedWords;
    }

    public void incProcessedWords() {
        ProcessedWords++;
    }

    public void addProcessedWords(long processedWords) {
        ProcessedWords += processedWords;
    }

    public long getProcessedLocations() {
        return ProcessedLocations;
    }

    public void setProcessedLocations(long processedLocations) {
        ProcessedLocations = processedLocations;
    }

    public void incProcessedLocations() {
        ProcessedLocations++;
    }

    public void addProcessedLocations(long processedLocations) {
        ProcessedLocations += processedLocations;
    }
    ...
    public void incKeysFound() {
        KeysFound++;
    }

    public void addtKeysFound(int keysFound) {
        KeysFound += keysFound;
    }
    ...
    public int getMostPopularWordLocations() {
        return MostPopularWordLocations;
    }

    public void setMostPopularWordLocations(int mostPopularWordLocations) {
        MostPopularWordLocations = mostPopularWordLocations;
    }
